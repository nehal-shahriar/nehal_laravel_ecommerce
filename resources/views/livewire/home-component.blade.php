<main id="main">
    <div class="container">
        ...
        <div class="wrap-main-slide">
            <div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="2" data-nav="true" data-dots="false">
                @foreach($sliders as $slider)
                <div class="item-slide">
                    <img src="{{ ('assets/images/sliders/'.$slider->image) }}" alt="{{$slider->title}}" class="img-slide" height="200px">
